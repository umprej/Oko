...
function game() {
    ...
    leaveButton.addEventListener('click', (event) => {
        if (confirm("Do you really want to leave the game?")) {
            ...
            `You started with \$${game.initialBet * (LIVES_MAX)} and are leaving with \$${game.playerBalance + game.initialBet * (game.livesLeft - 1)}\n`);
        }
